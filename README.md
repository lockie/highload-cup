...
* Идея по архитектуре: запилить всю внутрянку на C, а интерфейс к entity - на C++, чтобы опять не было [poor man's OOP](https://github.com/lockie/highload-cup/blob/eb53f7b3602c756946d6451b5c9c67da8b0ce26b/c/src/entity.c#L12) :sweat_smile: Для интроспекции в плюсах заюзать `boost::fusion`, или [Ponder](https://billyquith.github.io/ponder), или [boost_reflect](https://bytemaster.github.io/boost_reflect), или тупо `boost::tuple`. Или совсем тупо пачку макросов :laughing:
